...
exports.create = function (bot) {
    ...
    bot.dialog('subway', [
        function (session, args, next) {
            session.send("대중교통에서 물건을 분실하셨군요.  정말로 안타깝게 생각합니다.  우선 대중교통에서 습득된 유실물은 각 교통  수단별 유실물 관리소를 통해 확인 후 본인   인계가 이루어지는데, 인계가 어려워질 경우  경찰서로 인계되어 14일간 게시, 1년간 보관을 하게 됩니다.	 ");
            session.send("물건을 분실하신 곳이 도시철도가 맞으신가요?  맞으시면 '네' 라고 말씀해주시고요, 틀리면 대중교통 종류를 다시 말씀해주세요.  대중교통 종류는 시내버스, 도시철도, 마을버스, 법인택시, 개인택시 중에서 말씀해주시기   바라며, 그 외 경찰청 분실물 센터로 연결을 원하시면 '경찰청'이라고 말씀해주세요  ");
    ...
    bot.dialog('subwayPlace', [
        function (session) {
            session.send("물건 분실 장소로 도시철도를 선택하셨습니다.  도시철도의 유실물 관리는 부산교통공사이며,  전화번호는 640-7339 입니다.	바로 전화연결을 원하시면 '전화연결'이라고  말씀을 해주세요.   문자로 각 유실물 센터의 전화번호를 받아보고  싶으시면 휴대폰 번호를 입력해주세요.  ");
            builder.Prompts.text(session, "다시 들으시려면, '다시'라고 말씀해주세요");
        },

...
exports.create = function (bot) {
    ...
    bot.dialog('employment', [
        function (session, args, next) {
            builder.Prompts.text(session, "취업 지원에 대해 궁금하시군요. \n\n시에서는 다양한 취업지원을 하고 있습니다.	\n\n[청년 취업 지원 사이트] 와  [중소기업 청년 인턴사업] 중에서  원하시는 내용을 말씀해주시면  자세히 안내를 해드릴께요.\n\n"
    ...
    bot.dialog('employmentSite', [
        function (session, args, next) {
            builder.Prompts.text(session, "청년 취업 지원 사이트가 궁금하시군요.\n\n청년 취업 지원을 위해 '부산청년일자리센터'와  부산강소기업DB' 사이트를 운영하고 있습니다.\n\n보다 자세한 내용을 원하시면 사용하시는	휴대폰 번호를 말씀하시거나 입력해주세요.\n\n 휴대폰 문자로 자세한 정보가 있는 홈페이지  주소를 보내드리겠습니다."
                + "\n\n다시 들으시려면, '다시'라고 말씀해주세요");
        },
    ...
    bot.dialog('employmentBiz', [
        function (session, args, next) {
            builder.Prompts.text(session, "중소기업 청년 인턴사업이 궁금하시군요.\n\n중소기업 청년 인턴사업은 중소기업의 청년  인턴제를 시행하여 청년실업 및 중소기업  인력난을 해소하는 사업입니다.	\n\n  보다 자세한 내용을 원하시면 사용하시는  휴대폰 번호를 말씀하시거나 입력해주세요. \n\n  휴대폰 문자로 자세한 정보가 있는 홈페이지   주소를 보내드리겠습니다.\n\n"
                + "다시 들으시려면, '다시'라고 말씀해주세요");
        },
        function (session, results) {
            var res = results.response;
